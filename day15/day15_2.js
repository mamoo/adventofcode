...
fs.readFile("input.txt", 'utf8', function(err, data) {
    ...
    findCombinations().forEach(function(combination) {
        ...
        var calories = (ingredients[0].calories * combination[0] + ingredients[1].calories * combination[1] 
                    + ingredients[2].calories * combination[2] + ingredients[3].calories * combination[3]);
